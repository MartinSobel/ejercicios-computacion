# Una juguetería tiene promoción en dos de sus productos: payasos y muñecas.
...
p = int(input("Introduzca cantidad de payasos: "))
m = int(input("Introduzca cantidad de muñecas: "))
